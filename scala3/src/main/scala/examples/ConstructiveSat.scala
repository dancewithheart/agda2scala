...
object ConstructiveSat:
  ...
  enum Formula:
    case atom(x0: Variable)
    case neg(x0: Formula)
    case conj(x0: Formula, x1: Formula)
    case disj(x0: Formula, x1: Formula)
    case impl(x0: Formula, x1: Formula)
  ...
  def allEnvironments(): List[Environment] =
    Environment(false, false, false)
      ...
      :: Environment(true, false, true) :: Environment(true, true, false) :: Environment(true, true, true) :: Nil
